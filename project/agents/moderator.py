...
MODERATOR_PROMPT = (
    ...
    "5 — Summarizer: summarizes large text and lists main topics.\n"
    "\n"
...
"- If user asks: 'summarize', 'make a summary', 'TL;DR', 'short version', 'main topics' OR the input text is very long (e.g. more than ~800 characters),then choose Summarizer (5)."
