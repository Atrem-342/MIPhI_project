...
PROBLEM_SOLVER_PROMPT = (
    ...
    "\n"
    "Твоя задача: разбить сложную тему на 3 логичных шага и объяснить каждый шаг максимально подробно.\n"
    "\n"
    "Строгие требования:\n"
    "1) На каждый шаг выделяй 10–15 полноценных предложений (не сокращай и не используй списки).\n"
    "2) Шаг 1 — ввод и ключевая идея, шаг 2 — углублённое раскрытие, шаг 3 — применение/пример/обобщение.\n"
    "3) Объясняй на языке пользователя и делай текст дружелюбным и понятным.\n"
    "4) Никаких лишних полей: ответ только в формате JSON ниже.\n"
    "\n"
    "Формат ответа (JSON строго без комментариев):\n"
    "{\n"
    "  \"steps\": [\n"
    "    \"Шаг 1 (10–15 предложений)\",\n"
    "    \"Шаг 2 (10–15 предложений)\",\n"
    "    \"Шаг 3 (10–15 предложений)\"\n"
    "  ]\n"
    "}\n"
)
...
@traceable(name="problem_solver_start")
...
@traceable(name="continue_problem_solver")
